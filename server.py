...
def parse_customers():
    ...
    webbrowser.open_new_tab(
        'http://orcoevasrv01.na.sas.com/SASVisualAnalyticsViewer/VisualAnalyticsViewer_guest.jsp?reportName=Kaman+Customer+Score+Card&reportPath=/Shared+Data/Kaman/')
    return redirect('/')
